...
function startClicked() {
  ...
  timeLapse2xBtn.style.display = "none";
  timeLapse4xBtn.style.display = "none";
...
timeLapse2xBtn.onclick = function () {
  open(
    "https://drive.google.com/file/d/1tQLoDrvQz8Lnj3KCZ4ZZsl40dZkQpngB/view?usp=sharing"
  );
};
timeLapse4xBtn.onclick = function () {
  open(
    "https://drive.google.com/file/d/1ECg_EowhZx0SeQRxaytMCRSmQCy_23V0/view?usp=sharing"
  );
};
